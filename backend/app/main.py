...
from app.routes.manager_call_routes import public_router as manager_call_public_router, router as manager_call_router
...
app.include_router(manager_call_router)
