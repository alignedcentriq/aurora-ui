            ...
            <div className="p-4 sm:p-6 space-y-6">
              ...
              {buddyEnabled && (
                <>
                  {/* Gender picker */}
                  <div>
                    <p className="text-[12px] sm:text-[13px] font-medium text-foreground mb-3">Buddy Gender / Hairstyle</p>
                  ...
                  {/* Character picker */}
                  <div>
                    <p className="text-[12px] sm:text-[13px] font-medium text-foreground mb-3">Reaction Set</p>
                  ...
                  {/* Live preview */}
                  <div>
                    <p className="text-[12px] sm:text-[13px] font-medium text-foreground mb-3">AI Response States Preview</p>
