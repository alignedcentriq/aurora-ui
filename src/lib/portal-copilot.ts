...
const CONFIGS: Record<string, PortalCopilotConfig> = {
  ...
  "control-hub/hr-portal": {
    ...
    tagline: "Handle escalations, document requests, HR queries, and grievances.",
    starters: [
      "Show all open escalations",
      "How many pending document requests are there?",
      "Show open HR queries",
      "Show open grievances",
    ],
    placeholders: [
      "Open escalations",
