...
import {
  Award, Star, Trash2, Plus, Loader2, AlertCircle,
  CheckCircle2, Upload, FileText, Paperclip,
} from "lucide-react";
...
const SKILL_SUGGESTIONS = [
  "Python", "AWS", "Azure", "Project Management", "Scrum", "Kubernetes",
  "Data Analysis", "Machine Learning", "Java", "React", "SQL", "DevOps",
  "Cybersecurity", "Salesforce", "Networking", "TypeScript", "Node.js", "Power BI",
];
...
export function SkillsEditorWidget({ userEmail, userRole, prefill, onSaved }: Props) {
  ...
  const resetAddForm = () => {
    setNewSkill(""); setNewCert(""); setNewYears(""); setNewLastUsed("");
    setNewPrimary(false); setNewFile(null);
        ...
        <div className="rounded-xl border border-dashed border-border bg-muted/20 p-3.5">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <div>
              ...
              <input
                type="number" min="0" step="0.5" value={newYears}
            ...
            <div className="sm:col-span-2 flex flex-wrap items-center gap-3">
              ...
              <label className="ml-auto flex cursor-pointer items-center gap-1.5 text-xs text-muted-foreground">
                <input
                  type="checkbox" checked={newPrimary}
...
function SkillCard({
  skill, auth, onChanged, onError, validateFile,
}: {
  skill: Skill;
    ...
    <motion.div
      ...
      <div className="mb-2.5 flex items-center gap-2">
        <button
          ...
          className={skill.is_primary ? "text-amber-500" : "text-muted-foreground/40 hover:text-amber-500"}>
      ...
      <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2">
        <div>
          <label className={labelCls}>Years of experience</label>
          <input
            type="number" min="0" step="0.5" value={years}
