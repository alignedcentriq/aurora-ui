      ...
      {stage !== "fadeout" && (
        ...
        >
              ...
              {stage === "intro" && (
                ...
                >
                  <p className="text-white font-bold text-[13.5px] leading-snug">
                    Hey there! 👋 <br/>
                    <span className="text-pink-400 font-extrabold text-[12px] uppercase tracking-widest mt-1 block">Initializing Centriq</span>
                  </p>
                  {/* Arrow pointing down */}
          ...
          >
            ...
            <p className="text-white/40 text-[11px] font-bold uppercase tracking-[0.25em]">Workspace Concierge</p>
          </motion.div>
        </motion.div>
      )}
    </AnimatePresence>
