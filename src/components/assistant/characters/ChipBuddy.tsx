    ...
    >
      ...
      >
        ...
        <motion.g
          ...
          style={{ transformOrigin: "54px 20px" }}
        >
          <line
            x1="54"
            y1="11"
        ...
        <motion.path
          d="M 26 50 L 30 48 L 34 52 L 38 46 L 42 50 L 46 48"
          stroke={colors.light}
          strokeWidth="1.5"
          fill="none"
          strokeLinecap="round"
        ...
        <motion.text
          ...
          fontSize="7"
          fill="#f472b6"
          animate={{ opacity: [0.3, 0.8, 0.3], y: [10, 7, 10] }}
